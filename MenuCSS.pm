package Dancer2::Plugin::MenuCSS;
$Dancer2::Plugin::MenuCSS::VERSION = '0.009';
...
Dancer2::Plugin::MenuCSS - Automatically generate an HTML menu for your Dancer2 app
...
This module generates HTML for routes wrapped in the C<menu_item> keyword. MenuCSS
...
item. MenuCSS items within the current route are given the C<active> class so they
can be styled.
...
MenuCSS items that are not endpoints in the route or that don't have a C<title>,
...
You can find documentation for this module with the perldoc command.
  ...
  perldoc Dancer2::Plugin::MenuCSS
...
L<https://metacpan.org/release/Dancer2-Plugin-MenuCSS>
...
L<https://github.com/sdondley/Dancer2-Plugin-MenuCSS>

  git clone git://github.com/sdondley/Dancer2-Plugin-MenuCSS.git

=head1 BUGS AND LIMITATIONS

You can make new bug reports, and view existing ones, through the
web interface at L<https://github.com/sdondley/Dancer2-Plugin-MenuCSS/issues>.
